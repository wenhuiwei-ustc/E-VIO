...
class SEFormer(nn.Module):
    def __init__(self, dim, drop_path=0., layer_scale_init_value=1e-6, expan_ratio=6,
        ...
        self.pwconv1 = nn.Linear(self.dim, self.expan_ration * self.dim)
        self.pwconv0 = nn.Linear(self.dim, self.expan_ration * self.dim)
        self.act = nn.GELU()
